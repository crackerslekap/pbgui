...
def bt_queue():
    ...
    selected = st.data_editor(data=d, height=(len(my_btq.items)+1)*36, key=f'editor_{st.session_state.ed_bt_key}', hide_index=None, column_order=None, column_config=column_config, disabled=['User','Symbol','Exchange','Start','End','Balance'])
