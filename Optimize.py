...
class OptimizeQueue:
    ...
    def view_queue(self):
        ...
        st.data_editor(data=d, height=(len(d)+1)*36, key=f'editor_opt_queue_{ed_key}', hide_index=None, column_order=None, column_config=column_config, disabled=column_disabled)
...
class OptimizeResults:
    ...
    def view_results_l1(self):
        ...
        st.data_editor(data=d, height=36+(len(d))*35, key=f'editor_opt_results_{ed_key}', hide_index=None, column_order=None, column_config=column_config, disabled=['Algorithm / Mode','Results'])
    ...
    def view_results_l2(self):
        ...
        st.data_editor(data=d, height=36+(len(d))*35, key=f'editor_opt_results_l2_{ed_key}', hide_index=None, column_order=None, column_config=column_config, disabled=['Name'])
    ...
    def view_results_l3(self):
        ...
        results_d = st.data_editor(data=self.results_d, height=height, key=f'editor_opt_results_l3_{ed_key}', column_config=column_config, disabled=['path'])
